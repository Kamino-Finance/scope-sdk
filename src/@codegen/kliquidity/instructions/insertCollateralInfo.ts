...
export const INSERT_COLLATERAL_INFO_DISCRIMINATOR = new Uint8Array([
  22, 97, 4, 78, 166, 188, 51, 190,
]);

export function getInsertCollateralInfoDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    INSERT_COLLATERAL_INFO_DISCRIMINATOR,
  );
}
...
export function getInsertCollateralInfoInstructionDataEncoder(): FixedSizeEncoder<InsertCollateralInfoInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ["lowerHeuristic", getU64Encoder()],
      ["upperHeuristic", getU64Encoder()],
      ["expHeuristic", getU64Encoder()],
      ["maxTwapDivergenceBps", getU64Encoder()],
      ["scopeTwapPriceChain", getArrayEncoder(getU16Encoder(), { size: 4 })],
      ["scopePriceChain", getArrayEncoder(getU16Encoder(), { size: 4 })],
      ["name", fixEncoderSize(getBytesEncoder(), 32)],
      ["maxAgePriceSeconds", getU64Encoder()],
      ["maxAgeTwapSeconds", getU64Encoder()],
      ["maxIgnorableAmountAsReward", getU64Encoder()],
      ["disabled", getU8Encoder()],
      ["scopeStakingRateChain", getArrayEncoder(getU16Encoder(), { size: 4 })],
    ]),
    (value) => ({
      ...value,
      discriminator: INSERT_COLLATERAL_INFO_DISCRIMINATOR,
    }),
  );
}
...
export function getInsertCollateralInfoInstructionDataDecoder(): FixedSizeDecoder<InsertCollateralInfoInstructionData> {
  return getStructDecoder([
    ...
    ["lowerHeuristic", getU64Decoder()],
    ["upperHeuristic", getU64Decoder()],
    ["expHeuristic", getU64Decoder()],
    ["maxTwapDivergenceBps", getU64Decoder()],
    ["scopeTwapPriceChain", getArrayDecoder(getU16Decoder(), { size: 4 })],
    ["scopePriceChain", getArrayDecoder(getU16Decoder(), { size: 4 })],
    ["name", fixDecoderSize(getBytesDecoder(), 32)],
    ["maxAgePriceSeconds", getU64Decoder()],
    ["maxAgeTwapSeconds", getU64Decoder()],
    ["maxIgnorableAmountAsReward", getU64Decoder()],
    ["disabled", getU8Decoder()],
    ["scopeStakingRateChain", getArrayDecoder(getU16Decoder(), { size: 4 })],
  ]);
}

export function getInsertCollateralInfoInstructionDataCodec(): FixedSizeCodec<
  InsertCollateralInfoInstructionDataArgs,
  InsertCollateralInfoInstructionData
> {
  return combineCodec(
    getInsertCollateralInfoInstructionDataEncoder(),
    getInsertCollateralInfoInstructionDataDecoder(),
  );
}

export type InsertCollateralInfoInput<
...
export function getInsertCollateralInfoInstruction<
  TAccountAdminAuthority extends string,
  TAccountGlobalConfig extends string,
  TAccountTokenInfos extends string,
  TProgramAddress extends Address = typeof YVAULTS_PROGRAM_ADDRESS,
>(
  input: InsertCollateralInfoInput<
    TAccountAdminAuthority,
    TAccountGlobalConfig,
    TAccountTokenInfos
  >,
  config?: { programAddress?: TProgramAddress },
): InsertCollateralInfoInstruction<
  TProgramAddress,
  TAccountAdminAuthority,
  TAccountGlobalConfig,
  TAccountTokenInfos
> {
  ...
  const originalAccounts = {
    ...
    tokenInfos: { value: input.tokenInfos ?? null, isWritable: true },
  };
  ...
  return Object.freeze({
    ...
    data: getInsertCollateralInfoInstructionDataEncoder().encode(
      args as InsertCollateralInfoInstructionDataArgs,
    ),
    programAddress,
  } as InsertCollateralInfoInstruction<
    TProgramAddress,
    TAccountAdminAuthority,
    TAccountGlobalConfig,
    TAccountTokenInfos
...
export type ParsedInsertCollateralInfoInstruction<
  TProgram extends string = typeof YVAULTS_PROGRAM_ADDRESS,
...
export function parseInsertCollateralInfoInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>,
): ParsedInsertCollateralInfoInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getInsertCollateralInfoInstructionDataDecoder().decode(
      instruction.data,
    ),
  };
}
