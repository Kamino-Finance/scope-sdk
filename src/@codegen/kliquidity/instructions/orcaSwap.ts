...
export const ORCA_SWAP_DISCRIMINATOR = new Uint8Array([
  33, 94, 249, 97, 250, 254, 198, 93,
]);

export function getOrcaSwapDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(ORCA_SWAP_DISCRIMINATOR);
}
  ...
  InstructionWithAccounts<
    [
      ...
      TAccountTokenOwnerAccountA extends string
        ? ReadonlyAccount<TAccountTokenOwnerAccountA>
        : TAccountTokenOwnerAccountA,
      TAccountTokenVaultA extends string
        ? ReadonlyAccount<TAccountTokenVaultA>
        : TAccountTokenVaultA,
      ...
      TAccountTokenVaultB extends string
        ? ReadonlyAccount<TAccountTokenVaultB>
        : TAccountTokenVaultB,
...
export function getOrcaSwapInstructionDataEncoder(): FixedSizeEncoder<OrcaSwapInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: ORCA_SWAP_DISCRIMINATOR }),
  );
}
...
export function getOrcaSwapInstructionDataCodec(): FixedSizeCodec<
  OrcaSwapInstructionDataArgs,
  OrcaSwapInstructionData
> {
  return combineCodec(
    getOrcaSwapInstructionDataEncoder(),
    getOrcaSwapInstructionDataDecoder(),
  );
}

export type OrcaSwapInput<
...
export function getOrcaSwapInstruction<
  TAccountFunder extends string,
  TAccountTokenATokenProgram extends string,
  TAccountTokenBTokenProgram extends string,
  TAccountMemoProgram extends string,
...
> {
  ...
  const originalAccounts = {
    ...
    tokenVaultA: { value: input.tokenVaultA ?? null, isWritable: false },
    tokenOwnerAccountB: {
      value: input.tokenOwnerAccountB ?? null,
      isWritable: false,
    },
    tokenVaultB: { value: input.tokenVaultB ?? null, isWritable: false },
  ...
  return Object.freeze({
    ...
    data: getOrcaSwapInstructionDataEncoder().encode(
      args as OrcaSwapInstructionDataArgs,
    ),
    programAddress,
  } as OrcaSwapInstruction<
    TProgramAddress,
    TAccountFunder,
    TAccountTokenATokenProgram,
    TAccountTokenBTokenProgram,
...
export type ParsedOrcaSwapInstruction<
  TProgram extends string = typeof YVAULTS_PROGRAM_ADDRESS,
...
export function parseOrcaSwapInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>,
): ParsedOrcaSwapInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getOrcaSwapInstructionDataDecoder().decode(instruction.data),
  };
}
