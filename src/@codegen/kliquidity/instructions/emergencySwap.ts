...
export const EMERGENCY_SWAP_DISCRIMINATOR = new Uint8Array([
  73, 226, 248, 215, 5, 197, 211, 229,
]);

export function getEmergencySwapDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    EMERGENCY_SWAP_DISCRIMINATOR,
  );
}

export type EmergencySwapInstruction<
...
export type EmergencySwapInstructionData = {
  discriminator: ReadonlyUint8Array;
  aToB: boolean;
  targetLimitBps: bigint;
};

export type EmergencySwapInstructionDataArgs = {
  aToB: boolean;
...
export function getEmergencySwapInstructionDataEncoder(): FixedSizeEncoder<EmergencySwapInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: EMERGENCY_SWAP_DISCRIMINATOR }),
  );
}
...
export function getEmergencySwapInstructionDataCodec(): FixedSizeCodec<
  EmergencySwapInstructionDataArgs,
  EmergencySwapInstructionData
> {
  return combineCodec(
    getEmergencySwapInstructionDataEncoder(),
    getEmergencySwapInstructionDataDecoder(),
  );
}

export type EmergencySwapInput<
...
export function getEmergencySwapInstruction<
  TAccountAdminAuthority extends string,
  TAccountStrategy extends string,
  TAccountGlobalConfig extends string,
  TAccountTokenAMint extends string,
...
> {
  ...
  return Object.freeze({
    ...
    data: getEmergencySwapInstructionDataEncoder().encode(
      args as EmergencySwapInstructionDataArgs,
    ),
    programAddress,
  } as EmergencySwapInstruction<
    TProgramAddress,
    TAccountAdminAuthority,
    TAccountStrategy,
    TAccountGlobalConfig,
...
export type ParsedEmergencySwapInstruction<
  TProgram extends string = typeof YVAULTS_PROGRAM_ADDRESS,
...
export function parseEmergencySwapInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>,
): ParsedEmergencySwapInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getEmergencySwapInstructionDataDecoder().decode(instruction.data),
  };
}
