...
export type GlobalConfigArgs = {
  ...
  scopeProgramId: Address;
  scopePriceId: Address;
  swapRewardsDiscountBps: Array<number | bigint>;
  actionsAuthority: Address;
  adminAuthority: Address;
  treasuryFeeVaults: Array<Address>;
  tokenInfos: Address;
...
export function getGlobalConfigEncoder(): FixedSizeEncoder<GlobalConfigArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ["emergencyMode", getU64Encoder()],
      ["blockDeposit", getU64Encoder()],
      ["blockInvest", getU64Encoder()],
      ["blockWithdraw", getU64Encoder()],
      ["blockCollectFees", getU64Encoder()],
      ["blockCollectRewards", getU64Encoder()],
      ["blockSwapRewards", getU64Encoder()],
      ["blockSwapUnevenVaults", getU32Encoder()],
      ["blockEmergencySwap", getU32Encoder()],
      ["minWithdrawalFeeBps", getU64Encoder()],
      ["scopeProgramId", getAddressEncoder()],
      ["scopePriceId", getAddressEncoder()],
      [
        "swapRewardsDiscountBps",
        getArrayEncoder(getU64Encoder(), { size: 256 }),
      ],
      ["actionsAuthority", getAddressEncoder()],
      ["adminAuthority", getAddressEncoder()],
      [
        "treasuryFeeVaults",
        getArrayEncoder(getAddressEncoder(), { size: 256 }),
      ],
      ["tokenInfos", getAddressEncoder()],
      ["blockLocalAdmin", getU64Encoder()],
      ["minPerformanceFeeBps", getU64Encoder()],
      ["minSwapUnevenSlippageToleranceBps", getU64Encoder()],
      ["minReferencePriceSlippageToleranceBps", getU64Encoder()],
      ["actionsAfterRebalanceDelaySeconds", getU64Encoder()],
      ["treasuryFeeVaultReceiver", getAddressEncoder()],
      ["padding", getArrayEncoder(getU64Encoder(), { size: 2035 })],
    ]),
...
export function getGlobalConfigDecoder(): FixedSizeDecoder<GlobalConfig> {
  return getStructDecoder([
    ...
    ["emergencyMode", getU64Decoder()],
    ["blockDeposit", getU64Decoder()],
    ["blockInvest", getU64Decoder()],
    ["blockWithdraw", getU64Decoder()],
    ["blockCollectFees", getU64Decoder()],
    ["blockCollectRewards", getU64Decoder()],
    ["blockSwapRewards", getU64Decoder()],
    ["blockSwapUnevenVaults", getU32Decoder()],
    ["blockEmergencySwap", getU32Decoder()],
    ["minWithdrawalFeeBps", getU64Decoder()],
    ["scopeProgramId", getAddressDecoder()],
    ["scopePriceId", getAddressDecoder()],
    ["swapRewardsDiscountBps", getArrayDecoder(getU64Decoder(), { size: 256 })],
    ["actionsAuthority", getAddressDecoder()],
    ["adminAuthority", getAddressDecoder()],
    ["treasuryFeeVaults", getArrayDecoder(getAddressDecoder(), { size: 256 })],
    ["tokenInfos", getAddressDecoder()],
    ["blockLocalAdmin", getU64Decoder()],
    ["minPerformanceFeeBps", getU64Decoder()],
    ["minSwapUnevenSlippageToleranceBps", getU64Decoder()],
    ["minReferencePriceSlippageToleranceBps", getU64Decoder()],
    ["actionsAfterRebalanceDelaySeconds", getU64Decoder()],
    ["treasuryFeeVaultReceiver", getAddressDecoder()],
    ["padding", getArrayDecoder(getU64Decoder(), { size: 2035 })],
  ]);
}
