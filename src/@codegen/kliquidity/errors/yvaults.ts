...
export type YvaultsError =
  | typeof YVAULTS_ERROR__ACCOUNT_DIFFERENT_THAN_EXPECTED
  | typeof YVAULTS_ERROR__ACCOUNT_NOT_BELONG_TO_D_E_X
  | typeof YVAULTS_ERROR__AMOUNTS_REPRESENT_ZERO_SHARES
  | typeof YVAULTS_ERROR__BPS_NOT_IN_RANGE
  | typeof YVAULTS_ERROR__CANNOT_CHANGE_ADMIN_AUTHORITY
  | typeof YVAULTS_ERROR__CANNOT_COLLECT_FEES_ON_ZERO_LIQUIDITY_POSITION
  | typeof YVAULTS_ERROR__CANNOT_DEPOSIT_OUT_OF_RANGE
  | typeof YVAULTS_ERROR__CANNOT_EXECUTIVE_WITHDRAW_ZERO_AMOUNT
  | typeof YVAULTS_ERROR__CANNOT_INVEST_OUT_OF_RANGE
  | typeof YVAULTS_ERROR__CANNOT_INVEST_ZERO_AMOUNT
  | typeof YVAULTS_ERROR__CANNOT_RESIZE_ACCOUNT
  | typeof YVAULTS_ERROR__CANNOT_SWAP_UNEVEN_OUT_OF_RANGE
  | typeof YVAULTS_ERROR__CANNOT_WITHDRAW_ZERO_AMOUNT
  | typeof YVAULTS_ERROR__CHANGING_POOL_REWARD_MINT_MISMATCH
  | typeof YVAULTS_ERROR__COLLATERAL_INFO_ALREADY_EXISTS
  | typeof YVAULTS_ERROR__COLLATERAL_TOKENS_EXCEED_DEPOSIT_CAP
  | typeof YVAULTS_ERROR__COLLATERAL_TOKENS_EXCEED_DEPOSIT_CAP_PER_IXN
  | typeof YVAULTS_ERROR__COLLECT_FEES_BLOCKED
  | typeof YVAULTS_ERROR__COLLECT_REWARDS_BLOCKED
  | typeof YVAULTS_ERROR__COMPUTE_FEES_AND_REWARDS_INVALID_REWARD
  | typeof YVAULTS_ERROR__COMPUTE_FEES_AND_REWARDS_UPDATE_ERROR
  | typeof YVAULTS_ERROR__COULD_NOT_DESERIALIZE_REBALANCE_PARAMS
  | typeof YVAULTS_ERROR__COULD_NOT_DESERIALIZE_REBALANCE_STATE
  | typeof YVAULTS_ERROR__COULD_NOT_DESERIALIZE_SCOPE
  | typeof YVAULTS_ERROR__COULD_NOT_SERIALIZE_REBALANCE_STATE
  | typeof YVAULTS_ERROR__C_P_I_NOT_ALLOWED
  | typeof YVAULTS_ERROR__DECIMAL_NEGATIVE_SQRT_ROOT
  | typeof YVAULTS_ERROR__DECIMAL_OPERATION_FAILED
  | typeof YVAULTS_ERROR__DECIMAL_TO_U128_CONVERSION_FAILED
  | typeof YVAULTS_ERROR__DECIMAL_TO_U64_CONVERSION_FAILED
  | typeof YVAULTS_ERROR__DELTA_A_TOO_LARGE
  | typeof YVAULTS_ERROR__DELTA_B_TOO_LARGE
  | typeof YVAULTS_ERROR__DEPOSIT_AMOUNTS_ZERO
  | typeof YVAULTS_ERROR__DEPOSIT_LESS_THAN_MINIMUM
  | typeof YVAULTS_ERROR__DEPOSIT_WITHOUT_INVEST_DISALLOWED
  | typeof YVAULTS_ERROR__DIVIDE_BY_ZERO
  | typeof YVAULTS_ERROR__DRIFTING_OPPOSITE_DIRECTION
  | typeof YVAULTS_ERROR__EMERGENCY_SWAP_BLOCKED
  | typeof YVAULTS_ERROR__EMPTY_TREASURY
  | typeof YVAULTS_ERROR__EXISTING_REWARD_OVERRIDE
  | typeof YVAULTS_ERROR__FLASH_IXS_ACCOUNT_MISMATCH
  | typeof YVAULTS_ERROR__FLASH_IXS_INCLUDE_SCOPE
  | typeof YVAULTS_ERROR__FLASH_IXS_NOT_ENDED
  | typeof YVAULTS_ERROR__FLASH_SWAP_TOO_EARLY
  | typeof YVAULTS_ERROR__FLASH_TX_WITH_UNEXPECTED_IXS
  | typeof YVAULTS_ERROR__FLASH_VAULT_SWAP_BLOCKED
  | typeof YVAULTS_ERROR__FLASH_VAULT_SWAP_WRONG_AMOUNT_TO_LEAVE
  | typeof YVAULTS_ERROR__GLOBAL_CONFIG_KEY_ERROR
  | typeof YVAULTS_ERROR__GLOBAL_DEPOSIT_BLOCKED
  | typeof YVAULTS_ERROR__GLOBAL_INVEST_BLOCKED
  | typeof YVAULTS_ERROR__GLOBAL_WITHDRAW_BLOCKED
  | typeof YVAULTS_ERROR__INTEGER_OVERFLOW
  | typeof YVAULTS_ERROR__INVALID_ADMIN_AUTHORITY
  | typeof YVAULTS_ERROR__INVALID_B_P_S_VALUE
  | typeof YVAULTS_ERROR__INVALID_DEX_PROGRAM_ID
  | typeof YVAULTS_ERROR__INVALID_POSITION_ACCOUNT
  | typeof YVAULTS_ERROR__INVALID_REBALANCE_TYPE
  | typeof YVAULTS_ERROR__INVALID_REFERENCE_PRICE_TYPE
  | typeof YVAULTS_ERROR__INVALID_REWARD_INDEX
  | typeof YVAULTS_ERROR__INVALID_REWARD_MAPPING
  | typeof YVAULTS_ERROR__INVALID_SCOPE_CHAIN
  | typeof YVAULTS_ERROR__INVALID_SCOPE_STAKING_RATE_CHAIN
  | typeof YVAULTS_ERROR__INVALID_SCOPE_T_W_A_P_CHAIN
  | typeof YVAULTS_ERROR__INVALID_TICK
  | typeof YVAULTS_ERROR__INVEST_TOO_EARLY
  | typeof YVAULTS_ERROR__KAMINO_COLLATERAL_NOT_VALID
  | typeof YVAULTS_ERROR__KAMINO_REWARD_ALREADY_EXISTS
  | typeof YVAULTS_ERROR__KAMINO_REWARD_EXCEEDS_AVAILABLE_AMOUNT
  | typeof YVAULTS_ERROR__KAMINO_REWARD_NOT_EXIST
  | typeof YVAULTS_ERROR__LOWER_TICK_LARGER_THAN_UPPER_TICK
  | typeof YVAULTS_ERROR__LOWER_TICK_NOT_MULTIPLE_OF_TICK_SPACING
  | typeof YVAULTS_ERROR__LOWER_TICK_TOO_LOW
  | typeof YVAULTS_ERROR__MANUAL_REBALANCE_INVALID_OWNER
  | typeof YVAULTS_ERROR__MATH_OVERFLOW
  | typeof YVAULTS_ERROR__MAX_INVESTABLE_ZERO
  | typeof YVAULTS_ERROR__MAX_LOSS_EXCEEDED
  | typeof YVAULTS_ERROR__METEORA_MATH_OVERFLOW
  | typeof YVAULTS_ERROR__NO_REBALANCE_NECESSARY
  | typeof YVAULTS_ERROR__NOT_ENOUGH_TOKENS_FOR_RATIO
  | typeof YVAULTS_ERROR__OPERATION_FORBIDDEN
  | typeof YVAULTS_ERROR__ORCA_PRICE_TOO_DIFFERENT_FROM_SCOPE
  | typeof YVAULTS_ERROR__ORCA_REWARD_UNINITIALIZED
  | typeof YVAULTS_ERROR__OUT_OF_RANGE_INTEGRAL_CONVERSION
  | typeof YVAULTS_ERROR__OWN_REWARD_UNINITIALIZED
  | typeof YVAULTS_ERROR__PERMISSIONLESS_REBALANCING_DISABLED
  | typeof YVAULTS_ERROR__POOL_REBALANCING
  | typeof YVAULTS_ERROR__POSITION_HAS_REMAINING_LIQUIDITY
  | typeof YVAULTS_ERROR__PRICE_IS_BIGGER_THAN_HEURISTIC
  | typeof YVAULTS_ERROR__PRICE_IS_LOWER_THAN_HEURISTIC
  | typeof YVAULTS_ERROR__PRICE_NOT_VALID
  | typeof YVAULTS_ERROR__PRICE_TOO_DIVERGENT_FROM_TWAP
  | typeof YVAULTS_ERROR__PRICE_TOO_OLD
  | typeof YVAULTS_ERROR__PROVIDED_REWARD_VAULT_MISMATCH
  | typeof YVAULTS_ERROR__REBALANCES_CAP_REACHED
  | typeof YVAULTS_ERROR__REPEATED_MINT
  | typeof YVAULTS_ERROR__REWARD_NOT_STRATEGY_TOKEN
  | typeof YVAULTS_ERROR__REWARD_VAULT_OVERRIDE_NOT_ALLOWED
  | typeof YVAULTS_ERROR__SCOPE_CHAIN_UPDATE_FAILED
  | typeof YVAULTS_ERROR__SHARES_ISSUED_AMOUNT_DOES_NOT_MATCH
  | typeof YVAULTS_ERROR__SHARES_NOT_ZERO
  | typeof YVAULTS_ERROR__SHARES_ZERO
  | typeof YVAULTS_ERROR__STAKING_RATE_NOT_VALID
  | typeof YVAULTS_ERROR__STRATEGY_DEPOSIT_BLOCKED
  | typeof YVAULTS_ERROR__STRATEGY_FIELD_UPDATE_NOT_ALLOWED
  | typeof YVAULTS_ERROR__STRATEGY_INVEST_BLOCKED
  | typeof YVAULTS_ERROR__STRATEGY_NOT_ACTIVE
  | typeof YVAULTS_ERROR__STRATEGY_NOT_ACTIVE_WHEN_DEPOSITING
  | typeof YVAULTS_ERROR__STRATEGY_NOT_ACTIVE_WHEN_OPENING_POSITION
  | typeof YVAULTS_ERROR__STRATEGY_NOT_FROZEN
  | typeof YVAULTS_ERROR__STRATEGY_POSITION_NOT_VALID
  | typeof YVAULTS_ERROR__STRATEGY_TICK_ARRAY_NOT_VALID
  | typeof YVAULTS_ERROR__STRATEGY_WITHDRAW_BLOCKED
  | typeof YVAULTS_ERROR__SWAP_AMOUNTS_TOO_SMALL
  | typeof YVAULTS_ERROR__SWAP_AMOUNTS_ZERO
  | typeof YVAULTS_ERROR__SWAP_REWARD_IMBALANCED
  | typeof YVAULTS_ERROR__SWAP_REWARD_LESS_THAN_MINIMUM
  | typeof YVAULTS_ERROR__SWAP_REWARD_LESS_THAN_REQUESTED
  | typeof YVAULTS_ERROR__SWAP_REWARDS_BLOCKED
  | typeof YVAULTS_ERROR__SWAP_REWARD_TOO_SMALL
  | typeof YVAULTS_ERROR__SWAP_UNEVEN_INVALID_AUTHORITY
  | typeof YVAULTS_ERROR__SWAP_UNEVEN_TOO_EARLY
  | typeof YVAULTS_ERROR__SWAP_UNEVEN_VAULTS_BLOCKED
  | typeof YVAULTS_ERROR__SWAP_UNEVEN_VAULTS_OVERSHOOT
  | typeof YVAULTS_ERROR__SWAP_VAULTS_CASH_OUTPUT_BELOW_MINIMUM
  | typeof YVAULTS_ERROR__SWAP_VAULTS_TOO_BIG
  | typeof YVAULTS_ERROR__SYSTEM_IN_EMERGENCY_MODE
  | typeof YVAULTS_ERROR__TICK_ARRAYS_DO_NOT_MATCH_REBALANCE
  | typeof YVAULTS_ERROR__TIMESTAMP_DECREASE
  | typeof YVAULTS_ERROR__TOKEN_ACCOUNT_BALANCE_MISMATCH
  | typeof YVAULTS_ERROR__TOKEN_DISABLED
  | typeof YVAULTS_ERROR__TOKEN_TO_SWAP_NOT_ENOUGH
  | typeof YVAULTS_ERROR__TOO_MUCH_LIQUIDITY_TO_WITHDRAW
  | typeof YVAULTS_ERROR__UNABLE_TO_DESERIALIZE_ACCOUNT
  | typeof YVAULTS_ERROR__UNEXPECTED_PROGRAM_ID_FOR_PREREQUISITE_IX
  | typeof YVAULTS_ERROR__UNEXPECTED_TOKEN_AMOUNTS_POST_SWAP
  | typeof YVAULTS_ERROR__UNHARVESTED_AMOUNTS
  | typeof YVAULTS_ERROR__UNSUPPORTED_DEX
  | typeof YVAULTS_ERROR__UNSUPPORTED_DEX_FOR_TOKEN22
  | typeof YVAULTS_ERROR__UNSUPPORTED_TOKEN_EXTENSION
  | typeof YVAULTS_ERROR__UPPER_TICK_NOT_MULTIPLE_OF_TICK_SPACING
  | typeof YVAULTS_ERROR__UPPER_TICK_TOO_LARGE
  | typeof YVAULTS_ERROR__VAULT_BALANCE_DOES_NOT_MATCH_TOKEN_A
  | typeof YVAULTS_ERROR__VAULT_BALANCE_DOES_NOT_MATCH_TOKEN_B
  | typeof YVAULTS_ERROR__VAULT_BALANCES_CAUSES_WRONG_SHARES_ISSUANCE
  | typeof YVAULTS_ERROR__VAULTS_ARE_ALREADY_BALANCED
  | typeof YVAULTS_ERROR__WITHDRAWAL_CAP_REACHED
  | typeof YVAULTS_ERROR__WRONG_COLLATERAL_I_D
  | typeof YVAULTS_ERROR__WRONG_D_E_X_PROGRAM_I_D
  | typeof YVAULTS_ERROR__WRONG_DISCRIMINATOR
  | typeof YVAULTS_ERROR__WRONG_EVENT_AUTHORITY
  | typeof YVAULTS_ERROR__WRONG_KAMINO_REWARD_ID
  | typeof YVAULTS_ERROR__WRONG_MINT
  | typeof YVAULTS_ERROR__WRONG_REWARD_COLLATERAL_ID
  | typeof YVAULTS_ERROR__WRONG_REWARD_COLLATERAL_I_D
  | typeof YVAULTS_ERROR__WRONG_SWAP_VAULT_DIRECTION
  | typeof YVAULTS_ERROR__WRONG_VAULT
  | typeof YVAULTS_ERROR__ZERO_AMOUNT;

let yvaultsErrorMessages: Record<YvaultsError, string> | undefined;
if (process.env.NODE_ENV !== "production") {
  yvaultsErrorMessages = {
    [YVAULTS_ERROR__ACCOUNT_DIFFERENT_THAN_EXPECTED]: `Account different than expected`,
    [YVAULTS_ERROR__ACCOUNT_NOT_BELONG_TO_D_E_X]: `Account doesn't belong to the DEX`,
    [YVAULTS_ERROR__AMOUNTS_REPRESENT_ZERO_SHARES]: `The provided amounts are too small`,
    [YVAULTS_ERROR__BPS_NOT_IN_RANGE]: `Bps parameter passed to instruction is not in range`,
    [YVAULTS_ERROR__CANNOT_CHANGE_ADMIN_AUTHORITY]: `Cannot change admin authority`,
    [YVAULTS_ERROR__CANNOT_COLLECT_FEES_ON_ZERO_LIQUIDITY_POSITION]: `[DEPRECATED] Cannot collect fees on zero liquidity position`,
    [YVAULTS_ERROR__CANNOT_DEPOSIT_OUT_OF_RANGE]: `Cannot deposit when strategy out of range`,
    [YVAULTS_ERROR__CANNOT_EXECUTIVE_WITHDRAW_ZERO_AMOUNT]: `[DEPRECATED] Cannot executive withdraw zero amount`,
    [YVAULTS_ERROR__CANNOT_INVEST_OUT_OF_RANGE]: `Cannot invest when strategy out of range`,
    [YVAULTS_ERROR__CANNOT_INVEST_ZERO_AMOUNT]: `Cannot invest zero amount`,
    [YVAULTS_ERROR__CANNOT_RESIZE_ACCOUNT]: `Cannot resize with smaller new size`,
    [YVAULTS_ERROR__CANNOT_SWAP_UNEVEN_OUT_OF_RANGE]: `Cannot swap uneven vaults when position is out of range`,
    [YVAULTS_ERROR__CANNOT_WITHDRAW_ZERO_AMOUNT]: `Cannot withdraw zero amount`,
    [YVAULTS_ERROR__CHANGING_POOL_REWARD_MINT_MISMATCH]: `New pool reward mint does not match the old pool reward mint`,
    [YVAULTS_ERROR__COLLATERAL_INFO_ALREADY_EXISTS]: `Collateral info already exists for given index`,
    [YVAULTS_ERROR__COLLATERAL_TOKENS_EXCEED_DEPOSIT_CAP]: `Collaterals exceed deposit cap`,
    [YVAULTS_ERROR__COLLATERAL_TOKENS_EXCEED_DEPOSIT_CAP_PER_IXN]: `Collaterals exceed deposit ixn cap`,
    [YVAULTS_ERROR__COLLECT_FEES_BLOCKED]: `Collect fees is blocked`,
    [YVAULTS_ERROR__COLLECT_REWARDS_BLOCKED]: `Collect rewards is blocked`,
    [YVAULTS_ERROR__COMPUTE_FEES_AND_REWARDS_INVALID_REWARD]: `Got invalid reward from the dex specific function while computing the fees/rewards update`,
    [YVAULTS_ERROR__COMPUTE_FEES_AND_REWARDS_UPDATE_ERROR]: `Got an error from the dex specific function while computing the fees/rewards update`,
    [YVAULTS_ERROR__COULD_NOT_DESERIALIZE_REBALANCE_PARAMS]: `Rebalance params could not be deserialized`,
    [YVAULTS_ERROR__COULD_NOT_DESERIALIZE_REBALANCE_STATE]: `Rebalance state could not be deserialized`,
    [YVAULTS_ERROR__COULD_NOT_DESERIALIZE_SCOPE]: `Scope account could not be deserialized`,
    [YVAULTS_ERROR__COULD_NOT_SERIALIZE_REBALANCE_STATE]: `Rebalance state could not be serialized`,
    [YVAULTS_ERROR__C_P_I_NOT_ALLOWED]: `CPI not allowed`,
    [YVAULTS_ERROR__DECIMAL_NEGATIVE_SQRT_ROOT]: `Decimal sqrt on negative number`,
    [YVAULTS_ERROR__DECIMAL_OPERATION_FAILED]: `Decimal operation failed`,
    [YVAULTS_ERROR__DECIMAL_TO_U128_CONVERSION_FAILED]: `Decimal to u128 conversion failed`,
    [YVAULTS_ERROR__DECIMAL_TO_U64_CONVERSION_FAILED]: `Decimal to u64 conversion failed`,
    [YVAULTS_ERROR__DELTA_A_TOO_LARGE]: `[DEPRECATED] Delta A too large`,
    [YVAULTS_ERROR__DELTA_B_TOO_LARGE]: `[DEPRECATED] Delta B too large`,
    [YVAULTS_ERROR__DEPOSIT_AMOUNTS_ZERO]: `Deposit amounts must be greater than zero`,
    [YVAULTS_ERROR__DEPOSIT_LESS_THAN_MINIMUM]: `Deposit amount less than minimal allowed`,
    [YVAULTS_ERROR__DEPOSIT_WITHOUT_INVEST_DISALLOWED]: `Cannot deposit without invest`,
    [YVAULTS_ERROR__DIVIDE_BY_ZERO]: `Cannot divide by zero`,
    [YVAULTS_ERROR__DRIFTING_OPPOSITE_DIRECTION]: `Drifting strategy is moving in the opposite direction`,
    [YVAULTS_ERROR__EMERGENCY_SWAP_BLOCKED]: `Emergency Swap is blocked`,
    [YVAULTS_ERROR__EMPTY_TREASURY]: `No tokens to withdraw from treasury fee vault`,
    [YVAULTS_ERROR__EXISTING_REWARD_OVERRIDE]: `[DEPRECATED] Can not override the existing reward`,
    [YVAULTS_ERROR__FLASH_IXS_ACCOUNT_MISMATCH]: `Some accounts differ between the two flash ixs`,
    [YVAULTS_ERROR__FLASH_IXS_INCLUDE_SCOPE]: `A scope ix is present in a flash tx`,
    [YVAULTS_ERROR__FLASH_IXS_NOT_ENDED]: `Flash ixs initiated without the closing ix in the transaction`,
    [YVAULTS_ERROR__FLASH_SWAP_TOO_EARLY]: `Flash swap is too early after the position was opened`,
    [YVAULTS_ERROR__FLASH_TX_WITH_UNEXPECTED_IXS]: `Some unexpected instructions are present in the tx. Either before or after the flash ixs, or some ix target the same program between`,
    [YVAULTS_ERROR__FLASH_VAULT_SWAP_BLOCKED]: `Flash vault swap is blocked on this strategy`,
    [YVAULTS_ERROR__FLASH_VAULT_SWAP_WRONG_AMOUNT_TO_LEAVE]: `Unexpected amount of tokens in ata prior flash vault swap (wrong amount_to_leave_to_user)`,
    [YVAULTS_ERROR__GLOBAL_CONFIG_KEY_ERROR]: `Key is not present in global config`,
    [YVAULTS_ERROR__GLOBAL_DEPOSIT_BLOCKED]: `Global deposit is currently blocked`,
    [YVAULTS_ERROR__GLOBAL_INVEST_BLOCKED]: `Global invest is currently blocked`,
    [YVAULTS_ERROR__GLOBAL_WITHDRAW_BLOCKED]: `Global withdraw is currently blocked`,
    [YVAULTS_ERROR__INTEGER_OVERFLOW]: `Integer overflow`,
    [YVAULTS_ERROR__INVALID_ADMIN_AUTHORITY]: `Invalid admin authority`,
    [YVAULTS_ERROR__INVALID_B_P_S_VALUE]: `Invalid BPS value provided`,
    [YVAULTS_ERROR__INVALID_DEX_PROGRAM_ID]: `Invalid dex program id`,
    [YVAULTS_ERROR__INVALID_POSITION_ACCOUNT]: `Position account doesn't match internal records`,
    [YVAULTS_ERROR__INVALID_REBALANCE_TYPE]: `Invalid rebalance type for the strategy`,
    [YVAULTS_ERROR__INVALID_REFERENCE_PRICE_TYPE]: `Invalid reference price type`,
    [YVAULTS_ERROR__INVALID_REWARD_INDEX]: `Reward index incorrect`,
    [YVAULTS_ERROR__INVALID_REWARD_MAPPING]: `Reward mapping incorrect`,
    [YVAULTS_ERROR__INVALID_SCOPE_CHAIN]: `Invalid Scope Chain`,
    [YVAULTS_ERROR__INVALID_SCOPE_STAKING_RATE_CHAIN]: `Invalid Scope staking rate Chain`,
    [YVAULTS_ERROR__INVALID_SCOPE_T_W_A_P_CHAIN]: `Invalid Scope TWAP Chain`,
    [YVAULTS_ERROR__INVALID_TICK]: `Invalid tick requested`,
    [YVAULTS_ERROR__INVEST_TOO_EARLY]: `Invest is too early after the position was opened`,
    [YVAULTS_ERROR__KAMINO_COLLATERAL_NOT_VALID]: `Kamino collateral is not valid`,
    [YVAULTS_ERROR__KAMINO_REWARD_ALREADY_EXISTS]: `Kamino reward is already initialized`,
    [YVAULTS_ERROR__KAMINO_REWARD_EXCEEDS_AVAILABLE_AMOUNT]: `[DEPRECATED] Expected kamino reward is bigger then the available amount within the vault`,
    [YVAULTS_ERROR__KAMINO_REWARD_NOT_EXIST]: `Kamino reward is not initialized`,
    [YVAULTS_ERROR__LOWER_TICK_LARGER_THAN_UPPER_TICK]: `Lower tick larger than upper tick`,
    [YVAULTS_ERROR__LOWER_TICK_NOT_MULTIPLE_OF_TICK_SPACING]: `Lower tick is not a multiple of tick spacing`,
    [YVAULTS_ERROR__LOWER_TICK_TOO_LOW]: `Lower tick is lower than the minimal supported low tick`,
    [YVAULTS_ERROR__MANUAL_REBALANCE_INVALID_OWNER]: `Only the owner of the strategy can manually rebalance it`,
    [YVAULTS_ERROR__MATH_OVERFLOW]: `[DEPRECATED] Mathematical operation with overflow`,
    [YVAULTS_ERROR__MAX_INVESTABLE_ZERO]: `Cannot have zero investable amount`,
    [YVAULTS_ERROR__MAX_LOSS_EXCEEDED]: `Rouding errors exceed the maximal loss tolerance`,
    [YVAULTS_ERROR__METEORA_MATH_OVERFLOW]: `Meteora math overflowed`,
    [YVAULTS_ERROR__NO_REBALANCE_NECESSARY]: `No rebalance necessary based on current rebalance type/parameters`,
    [YVAULTS_ERROR__NOT_ENOUGH_TOKENS_FOR_RATIO]: `Deposit is not allowed as token amounts are not enough to match our holdings ratio`,
    [YVAULTS_ERROR__OPERATION_FORBIDDEN]: `Operation Forbidden`,
    [YVAULTS_ERROR__ORCA_PRICE_TOO_DIFFERENT_FROM_SCOPE]: `Cannot use orca price as it is too different from scope price`,
    [YVAULTS_ERROR__ORCA_REWARD_UNINITIALIZED]: `Cannot use uninitialized orca reward vault`,
    [YVAULTS_ERROR__OUT_OF_RANGE_INTEGRAL_CONVERSION]: `Out of range integral conversion attempted`,
    [YVAULTS_ERROR__OWN_REWARD_UNINITIALIZED]: `Cannot use uninitialized reward vault`,
    [YVAULTS_ERROR__PERMISSIONLESS_REBALANCING_DISABLED]: `Permissionless rebalancing is disabled`,
    [YVAULTS_ERROR__POOL_REBALANCING]: `Deposit is not allowed as pool is rebalancing`,
    [YVAULTS_ERROR__POSITION_HAS_REMAINING_LIQUIDITY]: `Existent position has liquidity, new position creation is forbidden`,
    [YVAULTS_ERROR__PRICE_IS_BIGGER_THAN_HEURISTIC]: `Token price is bigger than heuristic`,
    [YVAULTS_ERROR__PRICE_IS_LOWER_THAN_HEURISTIC]: `Token price is lower than heuristic`,
    [YVAULTS_ERROR__PRICE_NOT_VALID]: `Price is not valid`,
    [YVAULTS_ERROR__PRICE_TOO_DIVERGENT_FROM_TWAP]: `Price too divergent from twap`,
    [YVAULTS_ERROR__PRICE_TOO_OLD]: `Price too old`,
    [YVAULTS_ERROR__PROVIDED_REWARD_VAULT_MISMATCH]: `The provided reward vault does not match the strategy state`,
    [YVAULTS_ERROR__REBALANCES_CAP_REACHED]: `Rebalance caps reached, no rebalances are allowed until the end of the current interval`,
    [YVAULTS_ERROR__REPEATED_MINT]: `The provided reward vault does not match the strategy state`,
    [YVAULTS_ERROR__REWARD_NOT_STRATEGY_TOKEN]: `Reward does not match strategy token`,
    [YVAULTS_ERROR__REWARD_VAULT_OVERRIDE_NOT_ALLOWED]: `Reward vault override not allowed`,
    [YVAULTS_ERROR__SCOPE_CHAIN_UPDATE_FAILED]: `Scope chain update failed`,
    [YVAULTS_ERROR__SHARES_ISSUED_AMOUNT_DOES_NOT_MATCH]: `[DEPRECATED] Shares issued amount does not match`,
    [YVAULTS_ERROR__SHARES_NOT_ZERO]: `There must be no shares issued when closing a strategy`,
    [YVAULTS_ERROR__SHARES_ZERO]: `Number of shares to withdraw must be greater than zero`,
    [YVAULTS_ERROR__STAKING_RATE_NOT_VALID]: `Staking rate (provided by Scope) is not valid`,
    [YVAULTS_ERROR__STRATEGY_DEPOSIT_BLOCKED]: `Strategy deposit is currently blocked`,
    [YVAULTS_ERROR__STRATEGY_FIELD_UPDATE_NOT_ALLOWED]: `Strategy field update is not allowed`,
    [YVAULTS_ERROR__STRATEGY_INVEST_BLOCKED]: `Strategy invest is currently blocked`,
    [YVAULTS_ERROR__STRATEGY_NOT_ACTIVE]: `Strategy not active`,
    [YVAULTS_ERROR__STRATEGY_NOT_ACTIVE_WHEN_DEPOSITING]: `Cannot deposit inactive position`,
    [YVAULTS_ERROR__STRATEGY_NOT_ACTIVE_WHEN_OPENING_POSITION]: `Cannot open position with existing opened position`,
    [YVAULTS_ERROR__STRATEGY_NOT_FROZEN]: `Strategy is expected to be frozen for this operation`,
    [YVAULTS_ERROR__STRATEGY_POSITION_NOT_VALID]: `Expected strategy position to be initialized`,
    [YVAULTS_ERROR__STRATEGY_TICK_ARRAY_NOT_VALID]: `Expected strategy tick arrays to be initialized`,
    [YVAULTS_ERROR__STRATEGY_WITHDRAW_BLOCKED]: `Strategy withdraw is currently blocked`,
    [YVAULTS_ERROR__SWAP_AMOUNTS_TOO_SMALL]: `Swap amount below the minimum value`,
    [YVAULTS_ERROR__SWAP_AMOUNTS_ZERO]: `Swap amounts must be greater than zero`,
    [YVAULTS_ERROR__SWAP_REWARD_IMBALANCED]: `Must provide almost equal amounts of tokens`,
    [YVAULTS_ERROR__SWAP_REWARD_LESS_THAN_MINIMUM]: `Swap reward is less than minimum acceptable`,
    [YVAULTS_ERROR__SWAP_REWARD_LESS_THAN_REQUESTED]: `Swap reward is less than what user requested as minimum`,
    [YVAULTS_ERROR__SWAP_REWARDS_BLOCKED]: `Swap rewards is blocked`,
    [YVAULTS_ERROR__SWAP_REWARD_TOO_SMALL]: `Swap reward is zero or less than requested`,
    [YVAULTS_ERROR__SWAP_UNEVEN_INVALID_AUTHORITY]: `Cannot swap uneven because authority is set and the given signer does not correspond`,
    [YVAULTS_ERROR__SWAP_UNEVEN_TOO_EARLY]: `Swap uneven is too early after the position was opened`,
    [YVAULTS_ERROR__SWAP_UNEVEN_VAULTS_BLOCKED]: `Swap uneven vaults is blocked`,
    [YVAULTS_ERROR__SWAP_UNEVEN_VAULTS_OVERSHOOT]: `Swap uneven vaults result in the opposite unbalance of the vaults`,
    [YVAULTS_ERROR__SWAP_VAULTS_CASH_OUTPUT_BELOW_MINIMUM]: `Token out for cash based vault swap is below minimum expected`,
    [YVAULTS_ERROR__SWAP_VAULTS_TOO_BIG]: `Provided amount for vault swap is over the limit`,
    [YVAULTS_ERROR__SYSTEM_IN_EMERGENCY_MODE]: `[DEPRECATED] System is in emergency mode`,
    [YVAULTS_ERROR__TICK_ARRAYS_DO_NOT_MATCH_REBALANCE]: `The given tick arrays do not match the rebalance result`,
    [YVAULTS_ERROR__TIMESTAMP_DECREASE]: `Timestamp decrease`,
    [YVAULTS_ERROR__TOKEN_ACCOUNT_BALANCE_MISMATCH]: `Token amount in ata is different than the expected amount`,
    [YVAULTS_ERROR__TOKEN_DISABLED]: `Token cannot be used in strategy creation`,
    [YVAULTS_ERROR__TOKEN_TO_SWAP_NOT_ENOUGH]: `Token amount to be swapped is not enough`,
    [YVAULTS_ERROR__TOO_MUCH_LIQUIDITY_TO_WITHDRAW]: `Unable to withdraw more liquidity than available in position`,
    [YVAULTS_ERROR__UNABLE_TO_DESERIALIZE_ACCOUNT]: `Unable to deserialize account`,
    [YVAULTS_ERROR__UNEXPECTED_PROGRAM_ID_FOR_PREREQUISITE_IX]: `Unexpected programID for prerequisite ix`,
    [YVAULTS_ERROR__UNEXPECTED_TOKEN_AMOUNTS_POST_SWAP]: `Token left in vault post swap are lower than expected`,
    [YVAULTS_ERROR__UNHARVESTED_AMOUNTS]: `There are unharvested gains`,
    [YVAULTS_ERROR__UNSUPPORTED_DEX]: `DEX is not supported for this operation`,
    [YVAULTS_ERROR__UNSUPPORTED_DEX_FOR_TOKEN22]: `Cannot initialize strategy with this dex while having a mint with token22`,
    [YVAULTS_ERROR__UNSUPPORTED_TOKEN_EXTENSION]: `The token extension is not supported by the program`,
    [YVAULTS_ERROR__UPPER_TICK_NOT_MULTIPLE_OF_TICK_SPACING]: `Upper tick is not a multiple of tick spacing`,
    [YVAULTS_ERROR__UPPER_TICK_TOO_LARGE]: `Upper tick is larger than the maximum supported tick`,
    [YVAULTS_ERROR__VAULT_BALANCE_DOES_NOT_MATCH_TOKEN_A]: `[DEPRECATED] Vault balance does not match for token A`,
    [YVAULTS_ERROR__VAULT_BALANCE_DOES_NOT_MATCH_TOKEN_B]: `[DEPRECATED] Vault balance does not match for token B`,
    [YVAULTS_ERROR__VAULT_BALANCES_CAUSES_WRONG_SHARES_ISSUANCE]: `Deposit is not allowed as the strategy is not fully invested in the pool `,
    [YVAULTS_ERROR__VAULTS_ARE_ALREADY_BALANCED]: `Cannot swap as vaults are already balanced`,
    [YVAULTS_ERROR__WITHDRAWAL_CAP_REACHED]: `Withdrawal cap is reached`,
    [YVAULTS_ERROR__WRONG_COLLATERAL_I_D]: `[DEPRECATED] Collateral ID invalid for strategy`,
    [YVAULTS_ERROR__WRONG_D_E_X_PROGRAM_I_D]: `Wrong DEX program ID`,
    [YVAULTS_ERROR__WRONG_DISCRIMINATOR]: `Wrong discriminator`,
    [YVAULTS_ERROR__WRONG_EVENT_AUTHORITY]: `Wrong event authority`,
    [YVAULTS_ERROR__WRONG_KAMINO_REWARD_ID]: `Kamino reward id exceeds the available slots`,
    [YVAULTS_ERROR__WRONG_MINT]: `Wrong mint`,
    [YVAULTS_ERROR__WRONG_REWARD_COLLATERAL_ID]: `Wrong reward collateral_id`,
    [YVAULTS_ERROR__WRONG_REWARD_COLLATERAL_I_D]: `Reward collateral ID is incorrect for strategy`,
    [YVAULTS_ERROR__WRONG_SWAP_VAULT_DIRECTION]: `Vault swap can't be performed in the required direction`,
    [YVAULTS_ERROR__WRONG_VAULT]: `Wrong vault`,
    [YVAULTS_ERROR__ZERO_AMOUNT]: `[DEPRECATED] Zero amount`,
  };
}
