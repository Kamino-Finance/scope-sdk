...
export function getScopePriceIdTestCodec(): FixedSizeCodec<
  ScopePriceIdTestArgs,
  ScopePriceIdTest
> {
  return combineCodec(
    getScopePriceIdTestEncoder(),
    getScopePriceIdTestDecoder(),
  );
}
