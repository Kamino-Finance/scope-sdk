...
export enum StrategyConfigOption {
  UpdateDepositCap,
  UpdateDepositCapIxn,
...
export function getStrategyConfigOptionCodec(): FixedSizeCodec<
  StrategyConfigOptionArgs,
  StrategyConfigOption
> {
  return combineCodec(
    getStrategyConfigOptionEncoder(),
    getStrategyConfigOptionDecoder(),
  );
}
