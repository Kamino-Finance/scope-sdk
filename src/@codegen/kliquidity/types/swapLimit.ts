...
export type SwapLimit =
  | { __kind: "Bps"; fields: readonly [bigint] }
  | {
      __kind: "Absolute";
...
export type SwapLimitArgs =
  | { __kind: "Bps"; fields: readonly [number | bigint] }
  | {
      __kind: "Absolute";
      /** Amount of src token expected by the user to perform the swap */
...
export function getSwapLimitEncoder(): Encoder<SwapLimitArgs> {
  return getDiscriminatedUnionEncoder([
    ["Bps", getStructEncoder([["fields", getTupleEncoder([getU64Encoder()])]])],
    [
      "Absolute",
      getStructEncoder([
        ["srcAmountToSwap", getU64Encoder()],
        ["dstAmountToVault", getU64Encoder()],
...
export function getSwapLimitDecoder(): Decoder<SwapLimit> {
  return getDiscriminatedUnionDecoder([
    ["Bps", getStructDecoder([["fields", getTupleDecoder([getU64Decoder()])]])],
    [
      "Absolute",
      getStructDecoder([
        ["srcAmountToSwap", getU64Decoder()],
        ["dstAmountToVault", getU64Decoder()],
...
export function swapLimit(
  ...
  data: GetDiscriminatedUnionVariantContent<
    ...
    "Bps"
  >["fields"],
): GetDiscriminatedUnionVariant<SwapLimitArgs, "__kind", "Bps">;
export function swapLimit(
  kind: "Absolute",
  data: GetDiscriminatedUnionVariantContent<
    SwapLimitArgs,
    ...
    "Absolute"
  >,
): GetDiscriminatedUnionVariant<SwapLimitArgs, "__kind", "Absolute">;
export function swapLimit<K extends SwapLimitArgs["__kind"], Data>(
  kind: K,
  data?: Data,
) {
...
export function isSwapLimit<K extends SwapLimit["__kind"]>(
  kind: K,
  value: SwapLimit,
): value is SwapLimit & { __kind: K } {
