...
export type PricingParamsArgs = {
  tradeSpreadLong: number | bigint;
  tradeSpreadShort: number | bigint;
...
export function getPricingParamsEncoder(): FixedSizeEncoder<PricingParamsArgs> {
  return getStructEncoder([
    ["tradeSpreadLong", getU64Encoder()],
    ["tradeSpreadShort", getU64Encoder()],
...
export function getPricingParamsDecoder(): FixedSizeDecoder<PricingParams> {
  return getStructDecoder([
    ["tradeSpreadLong", getU64Decoder()],
    ["tradeSpreadShort", getU64Decoder()],
