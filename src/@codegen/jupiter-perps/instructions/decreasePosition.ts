...
export const DECREASE_POSITION_DISCRIMINATOR = new Uint8Array([
  57, 125, 21, 59, 200, 137, 179, 108,
]);

export function getDecreasePositionDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    DECREASE_POSITION_DISCRIMINATOR,
  );
}

export type DecreasePositionInstruction<
...
export type DecreasePositionInstructionData = {
  discriminator: ReadonlyUint8Array;
};

export type DecreasePositionInstructionDataArgs = {};

export function getDecreasePositionInstructionDataEncoder(): FixedSizeEncoder<DecreasePositionInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([["discriminator", fixEncoderSize(getBytesEncoder(), 8)]]),
    (value) => ({ ...value, discriminator: DECREASE_POSITION_DISCRIMINATOR }),
  );
}

export function getDecreasePositionInstructionDataDecoder(): FixedSizeDecoder<DecreasePositionInstructionData> {
  return getStructDecoder([
    ["discriminator", fixDecoderSize(getBytesDecoder(), 8)],
  ]);
}

export function getDecreasePositionInstructionDataCodec(): FixedSizeCodec<
  DecreasePositionInstructionDataArgs,
  DecreasePositionInstructionData
> {
  return combineCodec(
    getDecreasePositionInstructionDataEncoder(),
    getDecreasePositionInstructionDataDecoder(),
  );
}

export type DecreasePositionInput<
...
export function getDecreasePositionInstruction<
  TAccountKeeper extends string,
  TAccountKeeperAta extends string,
  TAccountOwner extends string,
  TAccountTransferAuthority extends string,
...
> {
  ...
  return Object.freeze({
    ...
    data: getDecreasePositionInstructionDataEncoder().encode({}),
    programAddress,
  } as DecreasePositionInstruction<
    TProgramAddress,
    TAccountKeeper,
    TAccountKeeperAta,
    TAccountOwner,
...
export type ParsedDecreasePositionInstruction<
  TProgram extends string = typeof PERPETUALS_PROGRAM_ADDRESS,
...
> = {
  ...
  data: DecreasePositionInstructionData;
};

export function parseDecreasePositionInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>,
): ParsedDecreasePositionInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    accounts: {
      ...
      keeperAta: getNextOptionalAccount(),
    ...
    data: getDecreasePositionInstructionDataDecoder().decode(instruction.data),
  };
}
